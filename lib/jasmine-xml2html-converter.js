...
var HTMLReport = function() {
    ...
    <script type="text/javascript"> \
        ...
        function drawCompareChart(dataSeriesCompare) { \
            ...
            var max = 0;\
            for(var numOfDays = 0; numOfDays < dataSeriesCompare.length; ++numOfDays){\
                for (var maxCounter = 1; maxCounter < dataSeriesCompare[0].length; maxCounter = maxCounter + 3){\
                    var tempCounter = 0;\
                    for(var k = 0; k < 3; k++){\
                        tempCounter += dataSeriesCompare[numOfDays][maxCounter + k];\
                    }\
